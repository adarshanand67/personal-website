...
import { clear, help, theme, matrix } from './commands/core';
...
export const commands: Record<string, Command> = {
    clear, help, skills, contact, theme, ls, cd, pwd, whoami, cat, sudo, rm, open, neofetch, github, haiku, history, calc, uptime, fortune, todo, joke, quote, echo, matrix, cls
};
