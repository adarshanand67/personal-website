...
export const mockFiles: Record<string, string> = {
    ...
    "about.md": "I am a Software Engineer passionate about low-level systems and security.",
    "contact.txt": "Email: adarshan20302@gmail.com\nLinkedIn: linkedin.com/in/adarshanand67",
};
    ...
    ls: {
        execute: (_: any, { setLines }: any) => {
            setLines((prev: string[]) => [
                ...prev,
                Object.keys(mockFiles).join("  ") + "  " + directories.map(d => d + "/").join("  "),
            ]);
        },
    },
    whoami: {
