...
const ForceGraph2D = dynamic(() => import('react-force-graph-2d'), {
    ssr: false,
    loading: () => <div className="h-[400px] w-full animate-pulse bg-green-500/5 rounded-xl flex items-center justify-center text-green-500 font-mono">Loading Neural Net...</div>
});
...
export function SkillGraph() {
    ...
    const data = {
        nodes: [
            { id: 'root', name: 'Adarsh', val: 20, color: '#22c55e' },
    ...
    return (
        <div ref={containerRef} className="w-full h-[400px] border border-green-500/20 rounded-xl overflow-hidden bg-black/5 dark:bg-black/40 backdrop-blur-sm relative group">
