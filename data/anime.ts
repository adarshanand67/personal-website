...
export const animeData = [
    ...
    },
    {
        ...
        description: "A hero who can end any fight with one punch struggles with boredom.",
        tags: ["Action", "Comedy"],
        year: "2015",
        rating: "8.7/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A group of teenagers obsessed with the gravitational manipulation of a spherical object, culminating in the decisive Dumpster Battle.",
        tags: ["Sports", "Drama"],
        year: "2014",
        rating: "8.9/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "Expatriate royalty utilizes ocular-based mind control to dismantle a global superpower.",
    ...
    },
    {
        ...
        description: "Jazz-infused nihilism in space with bounty hunters.",
        tags: ["Sci-Fi", "Action"],
        year: "1998",
        rating: "8.9/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A mad scientist invents a microwave phone to change the past, leading to a journey through time and alternate wordlines.",
        tags: ["Sci-Fi", "Thriller"],
        year: "2011",
        rating: "9.1/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A psychic middle schooler tries to live a normal life while suppressing his powers.",
        tags: ["Action", "Comedy"],
        year: "2016",
        rating: "8.6/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "Sorcerers fight curses born from negative human emotions. Includes the prequel story of Yuta Okkotsu.",
    ...
    },
    {
        ...
        description: "A ruthless athletic experiment designed to cultivate the ultimate egoist striker.",
    ...
    },
    {
        ...
        description: "The weakest hunter transcends limits through a unique system.",
        tags: ["Action", "Fantasy"],
        year: "2024",
        rating: "8.5/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A boy fights demons to cure his sister, facing nightmares on the Mugen Train and beyond.",
        tags: ["Action", "Fantasy"],
        year: "2019",
        rating: "9/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A student navigates a world of flesh-eating ghouls.",
        tags: ["Horror", "Action"],
        year: "2014",
        rating: "7.8/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A young soccer player learns the importance of vision on the field.",
        tags: ["Sports", "Drama"],
        year: "2022",
        rating: "8.1/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A boy merges with a chainsaw devil to hunt devils.",
        tags: ["Action", "Horror"],
        year: "2022",
        rating: "8.5/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A man travels back to childhood to prevent a murder.",
    ...
    },
    {
        ...
        description: "A genius rebuilds civilization from stone age with science.",
    ...
    },
    {
        ...
        description: "A viking seeks revenge but finds a path to peace.",
        tags: ["Action", "Drama"],
        year: "2019",
        rating: "8.8/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A bullied boy finds strength in boxing.",
        tags: ["Sports", "Action"],
        year: "2000",
        rating: "8.8/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "An ex-gangster teacher reforms delinquents.",
    ...
    },
    {
        ...
        description: "A phantom basketball player supports his team from the shadows.",
        tags: ["Sports"],
        year: "2012",
        rating: "8.4/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A story of a boy and a girl with a terminal illness.",
        tags: ["Drama", "Romance"],
        year: "2018",
        rating: "8.6/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "Two siblings struggle to survive WWII Japan.",
        tags: ["Drama", "War"],
        year: "1988",
        rating: "8.5/10",
        keyLearnings: [
    ...
    },
    {
        ...
        description: "A girl works in a spirit world bathhouse.",
    ...
    },
    {
        ...
        description: "Body-swapping teenagers connected by fate.",
